...
router.get('/get',passport.authenticate('jwt', { session: false }) ,dataCenterController.getAllDataCenters);
router.get('/:id',passport.authenticate('jwt', { session: false }) , dataCenterController.getDataCenterById);
