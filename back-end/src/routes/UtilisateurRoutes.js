...
router.get('/', utilisateurController.getAllUtilisateurs.bind(utilisateurController));
router.get('/:id', utilisateurController.getUtilisateurById.bind(utilisateurController));
router.post('/', utilisateurController.createUtilisateur.bind(utilisateurController));
